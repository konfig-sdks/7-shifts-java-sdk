...
public class ApiClient extends ApiClientCustom {
    ...
    private String basePath = "https://api.7shifts.com";
    private String tokenUrl = "https://app.7shifts.com/oauth2/token";
    ...
    public ApiClient(OkHttpClient client, Configuration configuration) {
        ...
        authentications.put("cookieAuth", new ApiKeyAuth("cookie", "7session"));
        authentications.put("marketingApiKeyAuth", new ApiKeyAuth("header", "Authorization-Marketing-API"));
        ...
        if (configuration != null) {
            ...
            if (configuration.marketingApiKeyAuth != null) {
                this.setMarketingApiKeyAuth(configuration.marketingApiKeyAuth);
            }
    ...
    public String getMarketingApiKeyAuth() {
        return ((ApiKeyAuth) this.getAuthentication("marketingApiKeyAuth")).getApiKey();
    }

    public void setMarketingApiKeyAuth(String apiKey) {
        ((ApiKeyAuth) this.getAuthentication("marketingApiKeyAuth")).setApiKey(apiKey);
    }

    public void setMarketingApiKeyAuthPrefix(String prefix) {
        ((ApiKeyAuth) this.getAuthentication("marketingApiKeyAuth")).setApiKeyPrefix(prefix);
    }
    ...
    private void init() {
        ...
        setUserAgent("Konfig/2023-05-01/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.7shifts.com)
     ...
     * Set token url
     *
     * @param tokenUrl Token URL for oauth (e.g https://app.7shifts.com/oauth2/token)
     * @return An instance of OkHttpClient
     */
