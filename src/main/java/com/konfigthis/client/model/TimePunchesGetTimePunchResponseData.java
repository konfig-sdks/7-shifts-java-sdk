...
public class TimePunchesGetTimePunchResponseData {
  ...
  private List<TimePunchesGetTimePunchResponseDataBreaksInner> breaks = null;
  ...
  public TimePunchesGetTimePunchResponseData() {
  }

  public TimePunchesGetTimePunchResponseData id(Integer id) {
  ...
  **/
  ...
  public TimePunchesGetTimePunchResponseData shiftId(Integer shiftId) {
  ...
  **/
  ...
  public TimePunchesGetTimePunchResponseData userId(Integer userId) {
  ...
  **/
  ...
  public TimePunchesGetTimePunchResponseData editablePunch(Boolean editablePunch) {
  ...
  **/
  ...
  public TimePunchesGetTimePunchResponseData roleId(Integer roleId) {
  ...
  **/
  ...
  public TimePunchesGetTimePunchResponseData companyId(Integer companyId) {
  ...
  **/
  ...
  public TimePunchesGetTimePunchResponseData locationId(Integer locationId) {
  ...
  **/
  ...
  public TimePunchesGetTimePunchResponseData departmentId(Integer departmentId) {
  ...
  **/
  ...
  public TimePunchesGetTimePunchResponseData hourlyWage(Integer hourlyWage) {
  ...
  **/
  ...
  public TimePunchesGetTimePunchResponseData approved(Boolean approved) {
  ...
  **/
  ...
  public TimePunchesGetTimePunchResponseData clockedIn(OffsetDateTime clockedIn) {
  ...
  **/
  ...
  public TimePunchesGetTimePunchResponseData clockedOut(OffsetDateTime clockedOut) {
  ...
  **/
  ...
  public TimePunchesGetTimePunchResponseData notes(String notes) {
  ...
  **/
  ...
  public TimePunchesGetTimePunchResponseData autoClockedOut(Boolean autoClockedOut) {
  ...
  **/
  ...
  public TimePunchesGetTimePunchResponseData clockedInOffline(Boolean clockedInOffline) {
  ...
  **/
  ...
  public TimePunchesGetTimePunchResponseData clockedOutOffline(Boolean clockedOutOffline) {
  ...
  **/
  ...
  public TimePunchesGetTimePunchResponseData tips(Integer tips) {
  ...
  **/
  ...
  public TimePunchesGetTimePunchResponseData posType(String posType) {
  ...
  **/
  ...
  public TimePunchesGetTimePunchResponseData breaks(List<TimePunchesGetTimePunchResponseDataBreaksInner> breaks) {
  ...
  public TimePunchesGetTimePunchResponseData addBreaksItem(TimePunchesGetTimePunchResponseDataBreaksInner breaksItem) {
    if (this.breaks == null) {
  ...
  **/
  ...
  public List<TimePunchesGetTimePunchResponseDataBreaksInner> getBreaks() {
    return breaks;
  }


  public void setBreaks(List<TimePunchesGetTimePunchResponseDataBreaksInner> breaks) {
  ...
  public TimePunchesGetTimePunchResponseData created(OffsetDateTime created) {
  ...
  **/
  ...
  public TimePunchesGetTimePunchResponseData modified(OffsetDateTime modified) {
  ...
  **/
  ...
  public TimePunchesGetTimePunchResponseData deleted(Boolean deleted) {
  ...
  **/
   ...
   * @return the TimePunchesGetTimePunchResponseData instance itself
   */
  public TimePunchesGetTimePunchResponseData putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    TimePunchesGetTimePunchResponseData timePunchesGetTimePunchResponseData = (TimePunchesGetTimePunchResponseData) o;
    return Objects.equals(this.id, timePunchesGetTimePunchResponseData.id) &&
        Objects.equals(this.shiftId, timePunchesGetTimePunchResponseData.shiftId) &&
        Objects.equals(this.userId, timePunchesGetTimePunchResponseData.userId) &&
        Objects.equals(this.editablePunch, timePunchesGetTimePunchResponseData.editablePunch) &&
        Objects.equals(this.roleId, timePunchesGetTimePunchResponseData.roleId) &&
        Objects.equals(this.companyId, timePunchesGetTimePunchResponseData.companyId) &&
        Objects.equals(this.locationId, timePunchesGetTimePunchResponseData.locationId) &&
        Objects.equals(this.departmentId, timePunchesGetTimePunchResponseData.departmentId) &&
        Objects.equals(this.hourlyWage, timePunchesGetTimePunchResponseData.hourlyWage) &&
        Objects.equals(this.approved, timePunchesGetTimePunchResponseData.approved) &&
        Objects.equals(this.clockedIn, timePunchesGetTimePunchResponseData.clockedIn) &&
        Objects.equals(this.clockedOut, timePunchesGetTimePunchResponseData.clockedOut) &&
        Objects.equals(this.notes, timePunchesGetTimePunchResponseData.notes) &&
        Objects.equals(this.autoClockedOut, timePunchesGetTimePunchResponseData.autoClockedOut) &&
        Objects.equals(this.clockedInOffline, timePunchesGetTimePunchResponseData.clockedInOffline) &&
        Objects.equals(this.clockedOutOffline, timePunchesGetTimePunchResponseData.clockedOutOffline) &&
        Objects.equals(this.tips, timePunchesGetTimePunchResponseData.tips) &&
        Objects.equals(this.posType, timePunchesGetTimePunchResponseData.posType) &&
        Objects.equals(this.breaks, timePunchesGetTimePunchResponseData.breaks) &&
        Objects.equals(this.created, timePunchesGetTimePunchResponseData.created) &&
        Objects.equals(this.modified, timePunchesGetTimePunchResponseData.modified) &&
        Objects.equals(this.deleted, timePunchesGetTimePunchResponseData.deleted)&&
        Objects.equals(this.additionalProperties, timePunchesGetTimePunchResponseData.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class TimePunchesGetTimePunchResponseData {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to TimePunchesGetTimePunchResponseData
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TimePunchesGetTimePunchResponseData.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TimePunchesGetTimePunchResponseData is not found in the empty JSON string", TimePunchesGetTimePunchResponseData.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TimePunchesGetTimePunchResponseData.openapiRequiredFields) {
      ...
      if (jsonObj.get("breaks") != null && !jsonObj.get("breaks").isJsonNull()) {
        ...
        if (jsonArraybreaks != null) {
          ...
          for (int i = 0; i < jsonArraybreaks.size(); i++) {
            TimePunchesGetTimePunchResponseDataBreaksInner.validateJsonObject(jsonArraybreaks.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TimePunchesGetTimePunchResponseData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TimePunchesGetTimePunchResponseData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TimePunchesGetTimePunchResponseData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TimePunchesGetTimePunchResponseData.class));

       return (TypeAdapter<T>) new TypeAdapter<TimePunchesGetTimePunchResponseData>() {
           @Override
           public void write(JsonWriter out, TimePunchesGetTimePunchResponseData value) throws IOException {
           ...
           @Override
           public TimePunchesGetTimePunchResponseData read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             TimePunchesGetTimePunchResponseData instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of TimePunchesGetTimePunchResponseData given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of TimePunchesGetTimePunchResponseData
  * @throws IOException if the JSON string is invalid with respect to TimePunchesGetTimePunchResponseData
  */
  public static TimePunchesGetTimePunchResponseData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TimePunchesGetTimePunchResponseData.class);
  }

 /**
  * Convert an instance of TimePunchesGetTimePunchResponseData to an JSON string
  *
  * @return JSON string
  */
