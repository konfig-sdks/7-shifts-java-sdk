...
public class ShiftsUpdateShiftByIdResponseData {
 ...
 public enum PublishStatusEnum {
  ...
  public ShiftsUpdateShiftByIdResponseData() {
  }
  ...
  public ShiftsUpdateShiftByIdResponseData id(Integer id) {
  ...
  **/
  ...
  public ShiftsUpdateShiftByIdResponseData userId(Integer userId) {
  ...
  **/
  ...
  public ShiftsUpdateShiftByIdResponseData start(OffsetDateTime start) {
  ...
  **/
  ...
  public ShiftsUpdateShiftByIdResponseData end(OffsetDateTime end) {
  ...
  **/
  ...
  public ShiftsUpdateShiftByIdResponseData close(Boolean close) {
  ...
  **/
  ...
  public ShiftsUpdateShiftByIdResponseData businessDecline(Boolean businessDecline) {
  ...
  **/
  ...
  public ShiftsUpdateShiftByIdResponseData departmentId(Integer departmentId) {
  ...
  **/
  ...
  public ShiftsUpdateShiftByIdResponseData locationId(Integer locationId) {
  ...
  **/
  ...
  public ShiftsUpdateShiftByIdResponseData roleId(Integer roleId) {
  ...
  **/
  ...
  public ShiftsUpdateShiftByIdResponseData notes(String notes) {
  ...
  **/
  ...
  public ShiftsUpdateShiftByIdResponseData draft(Boolean draft) {
  ...
  **/
  ...
  public ShiftsUpdateShiftByIdResponseData notified(Boolean notified) {
  ...
  **/
  ...
  public ShiftsUpdateShiftByIdResponseData open(Boolean open) {
  ...
  **/
  ...
  public ShiftsUpdateShiftByIdResponseData unassigned(Boolean unassigned) {
  ...
  **/
  ...
  public ShiftsUpdateShiftByIdResponseData unassignedSkillLevel(Integer unassignedSkillLevel) {
  ...
  **/
  ...
  public ShiftsUpdateShiftByIdResponseData openOfferType(OpenOfferTypeEnum openOfferType) {
  ...
  **/
  ...
  public ShiftsUpdateShiftByIdResponseData attendanceStatus(AttendanceStatusEnum attendanceStatus) {
  ...
  **/
  ...
  public ShiftsUpdateShiftByIdResponseData publishStatus(PublishStatusEnum publishStatus) {
  ...
  **/
  ...
  public ShiftsUpdateShiftByIdResponseData lateMinuets(Integer lateMinuets) {
  ...
  **/
  ...
  public ShiftsUpdateShiftByIdResponseData created(OffsetDateTime created) {
  ...
  **/
  ...
  public ShiftsUpdateShiftByIdResponseData modified(OffsetDateTime modified) {
  ...
  **/
  ...
  public ShiftsUpdateShiftByIdResponseData deleted(Boolean deleted) {
  ...
  **/
  ...
  public ShiftsUpdateShiftByIdResponseData softDeleted(String softDeleted) {
  ...
  **/
  ...
  public ShiftsUpdateShiftByIdResponseData station(Integer station) {
  ...
  **/
  ...
  public ShiftsUpdateShiftByIdResponseData stationName(String stationName) {
  ...
  **/
  ...
  public ShiftsUpdateShiftByIdResponseData stationId(Integer stationId) {
  ...
  **/
  ...
  public ShiftsUpdateShiftByIdResponseData breaks(List<ShiftsListResponseDataInnerBreaksInner> breaks) {
  ...
  public ShiftsUpdateShiftByIdResponseData addBreaksItem(ShiftsListResponseDataInnerBreaksInner breaksItem) {
    if (this.breaks == null) {
  ...
  **/
   ...
   * @return the ShiftsUpdateShiftByIdResponseData instance itself
   */
  public ShiftsUpdateShiftByIdResponseData putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ShiftsUpdateShiftByIdResponseData shiftsUpdateShiftByIdResponseData = (ShiftsUpdateShiftByIdResponseData) o;
    return Objects.equals(this.id, shiftsUpdateShiftByIdResponseData.id) &&
        Objects.equals(this.userId, shiftsUpdateShiftByIdResponseData.userId) &&
        Objects.equals(this.start, shiftsUpdateShiftByIdResponseData.start) &&
        Objects.equals(this.end, shiftsUpdateShiftByIdResponseData.end) &&
        Objects.equals(this.close, shiftsUpdateShiftByIdResponseData.close) &&
        Objects.equals(this.businessDecline, shiftsUpdateShiftByIdResponseData.businessDecline) &&
        Objects.equals(this.hourlyWage, shiftsUpdateShiftByIdResponseData.hourlyWage) &&
        Objects.equals(this.departmentId, shiftsUpdateShiftByIdResponseData.departmentId) &&
        Objects.equals(this.locationId, shiftsUpdateShiftByIdResponseData.locationId) &&
        Objects.equals(this.roleId, shiftsUpdateShiftByIdResponseData.roleId) &&
        Objects.equals(this.notes, shiftsUpdateShiftByIdResponseData.notes) &&
        Objects.equals(this.draft, shiftsUpdateShiftByIdResponseData.draft) &&
        Objects.equals(this.notified, shiftsUpdateShiftByIdResponseData.notified) &&
        Objects.equals(this.open, shiftsUpdateShiftByIdResponseData.open) &&
        Objects.equals(this.unassigned, shiftsUpdateShiftByIdResponseData.unassigned) &&
        Objects.equals(this.unassignedSkillLevel, shiftsUpdateShiftByIdResponseData.unassignedSkillLevel) &&
        Objects.equals(this.openOfferType, shiftsUpdateShiftByIdResponseData.openOfferType) &&
        Objects.equals(this.attendanceStatus, shiftsUpdateShiftByIdResponseData.attendanceStatus) &&
        Objects.equals(this.publishStatus, shiftsUpdateShiftByIdResponseData.publishStatus) &&
        Objects.equals(this.lateMinuets, shiftsUpdateShiftByIdResponseData.lateMinuets) &&
        Objects.equals(this.created, shiftsUpdateShiftByIdResponseData.created) &&
        Objects.equals(this.modified, shiftsUpdateShiftByIdResponseData.modified) &&
        Objects.equals(this.deleted, shiftsUpdateShiftByIdResponseData.deleted) &&
        Objects.equals(this.softDeleted, shiftsUpdateShiftByIdResponseData.softDeleted) &&
        Objects.equals(this.station, shiftsUpdateShiftByIdResponseData.station) &&
        Objects.equals(this.stationName, shiftsUpdateShiftByIdResponseData.stationName) &&
        Objects.equals(this.stationId, shiftsUpdateShiftByIdResponseData.stationId) &&
        Objects.equals(this.breaks, shiftsUpdateShiftByIdResponseData.breaks)&&
        Objects.equals(this.additionalProperties, shiftsUpdateShiftByIdResponseData.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ShiftsUpdateShiftByIdResponseData {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ShiftsUpdateShiftByIdResponseData
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ShiftsUpdateShiftByIdResponseData.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ShiftsUpdateShiftByIdResponseData is not found in the empty JSON string", ShiftsUpdateShiftByIdResponseData.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ShiftsUpdateShiftByIdResponseData.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ShiftsUpdateShiftByIdResponseData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ShiftsUpdateShiftByIdResponseData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ShiftsUpdateShiftByIdResponseData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ShiftsUpdateShiftByIdResponseData.class));

       return (TypeAdapter<T>) new TypeAdapter<ShiftsUpdateShiftByIdResponseData>() {
           @Override
           public void write(JsonWriter out, ShiftsUpdateShiftByIdResponseData value) throws IOException {
           ...
           @Override
           public ShiftsUpdateShiftByIdResponseData read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ShiftsUpdateShiftByIdResponseData instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ShiftsUpdateShiftByIdResponseData given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ShiftsUpdateShiftByIdResponseData
  * @throws IOException if the JSON string is invalid with respect to ShiftsUpdateShiftByIdResponseData
  */
  public static ShiftsUpdateShiftByIdResponseData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ShiftsUpdateShiftByIdResponseData.class);
  }

 /**
  * Convert an instance of ShiftsUpdateShiftByIdResponseData to an JSON string
  *
  * @return JSON string
  */
