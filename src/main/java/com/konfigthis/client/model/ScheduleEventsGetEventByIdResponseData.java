...
public class ScheduleEventsGetEventByIdResponseData {
 ...
 public enum EventTypeEnum {
  ...
  public ScheduleEventsGetEventByIdResponseData() {
  }

  public ScheduleEventsGetEventByIdResponseData id(Integer id) {
  ...
  **/
  ...
  public ScheduleEventsGetEventByIdResponseData eventType(EventTypeEnum eventType) {
  ...
  **/
  ...
  public ScheduleEventsGetEventByIdResponseData title(String title) {
  ...
  **/
  ...
  public ScheduleEventsGetEventByIdResponseData description(String description) {
  ...
  **/
  ...
  public ScheduleEventsGetEventByIdResponseData locationIds(List<Integer> locationIds) {
  ...
  public ScheduleEventsGetEventByIdResponseData addLocationIdsItem(Integer locationIdsItem) {
  ...
  **/
  ...
  public ScheduleEventsGetEventByIdResponseData start(List<ScheduleEventsListEventsResponseDataInnerAllOf1StartInner> start) {
  ...
  public ScheduleEventsGetEventByIdResponseData addStartItem(ScheduleEventsListEventsResponseDataInnerAllOf1StartInner startItem) {
    if (this.start == null) {
  ...
  **/
  ...
  public ScheduleEventsGetEventByIdResponseData startDate(String startDate) {
  ...
  **/
  ...
  public ScheduleEventsGetEventByIdResponseData startTime(String startTime) {
  ...
  **/
  ...
  public ScheduleEventsGetEventByIdResponseData end(List<ScheduleEventsListEventsResponseDataInnerAllOf1EndInner> end) {
  ...
  public ScheduleEventsGetEventByIdResponseData addEndItem(ScheduleEventsListEventsResponseDataInnerAllOf1EndInner endItem) {
    if (this.end == null) {
  ...
  **/
  ...
  public ScheduleEventsGetEventByIdResponseData endDate(String endDate) {
  ...
  **/
  ...
  public ScheduleEventsGetEventByIdResponseData endTime(String endTime) {
  ...
  **/
  ...
  public ScheduleEventsGetEventByIdResponseData color(String color) {
  ...
  **/
  ...
  public ScheduleEventsGetEventByIdResponseData isMultiDay(Boolean isMultiDay) {
  ...
  **/
  ...
  public ScheduleEventsGetEventByIdResponseData recurrence(String recurrence) {
  ...
  **/
   ...
   * @return the ScheduleEventsGetEventByIdResponseData instance itself
   */
  public ScheduleEventsGetEventByIdResponseData putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ScheduleEventsGetEventByIdResponseData scheduleEventsGetEventByIdResponseData = (ScheduleEventsGetEventByIdResponseData) o;
    return Objects.equals(this.id, scheduleEventsGetEventByIdResponseData.id) &&
        Objects.equals(this.eventType, scheduleEventsGetEventByIdResponseData.eventType) &&
        Objects.equals(this.title, scheduleEventsGetEventByIdResponseData.title) &&
        Objects.equals(this.description, scheduleEventsGetEventByIdResponseData.description) &&
        Objects.equals(this.locationIds, scheduleEventsGetEventByIdResponseData.locationIds) &&
        Objects.equals(this.start, scheduleEventsGetEventByIdResponseData.start) &&
        Objects.equals(this.startDate, scheduleEventsGetEventByIdResponseData.startDate) &&
        Objects.equals(this.startTime, scheduleEventsGetEventByIdResponseData.startTime) &&
        Objects.equals(this.end, scheduleEventsGetEventByIdResponseData.end) &&
        Objects.equals(this.endDate, scheduleEventsGetEventByIdResponseData.endDate) &&
        Objects.equals(this.endTime, scheduleEventsGetEventByIdResponseData.endTime) &&
        Objects.equals(this.color, scheduleEventsGetEventByIdResponseData.color) &&
        Objects.equals(this.isMultiDay, scheduleEventsGetEventByIdResponseData.isMultiDay) &&
        Objects.equals(this.recurrence, scheduleEventsGetEventByIdResponseData.recurrence)&&
        Objects.equals(this.additionalProperties, scheduleEventsGetEventByIdResponseData.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ScheduleEventsGetEventByIdResponseData {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ScheduleEventsGetEventByIdResponseData
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ScheduleEventsGetEventByIdResponseData.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ScheduleEventsGetEventByIdResponseData is not found in the empty JSON string", ScheduleEventsGetEventByIdResponseData.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ScheduleEventsGetEventByIdResponseData.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ScheduleEventsGetEventByIdResponseData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ScheduleEventsGetEventByIdResponseData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ScheduleEventsGetEventByIdResponseData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ScheduleEventsGetEventByIdResponseData.class));

       return (TypeAdapter<T>) new TypeAdapter<ScheduleEventsGetEventByIdResponseData>() {
           @Override
           public void write(JsonWriter out, ScheduleEventsGetEventByIdResponseData value) throws IOException {
           ...
           @Override
           public ScheduleEventsGetEventByIdResponseData read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ScheduleEventsGetEventByIdResponseData instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ScheduleEventsGetEventByIdResponseData given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ScheduleEventsGetEventByIdResponseData
  * @throws IOException if the JSON string is invalid with respect to ScheduleEventsGetEventByIdResponseData
  */
  public static ScheduleEventsGetEventByIdResponseData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ScheduleEventsGetEventByIdResponseData.class);
  }

 /**
  * Convert an instance of ScheduleEventsGetEventByIdResponseData to an JSON string
  *
  * @return JSON string
  */
