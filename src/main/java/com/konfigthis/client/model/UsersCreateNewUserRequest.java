...
public class UsersCreateNewUserRequest {
 ...
 public enum WageTypeEnum {
  ...
  private List<UsersCreateNewUserRequestWagesInner> wages = null;
  ...
  **/
  ...
  public UsersCreateNewUserRequest preferredFirstName(String preferredFirstName) {
  ...
  **/
  ...
  public UsersCreateNewUserRequest preferredLastName(String preferredLastName) {
  ...
  **/
  ...
  public UsersCreateNewUserRequest locationIds(List<Integer> locationIds) {
  ...
  public UsersCreateNewUserRequest addLocationIdsItem(Integer locationIdsItem) {
  ...
  **/
  ...
  public UsersCreateNewUserRequest departmentIds(List<Integer> departmentIds) {
  ...
  public UsersCreateNewUserRequest addDepartmentIdsItem(Integer departmentIdsItem) {
  ...
  **/
  ...
  public UsersCreateNewUserRequest roleIds(List<Integer> roleIds) {
  ...
  public UsersCreateNewUserRequest addRoleIdsItem(Integer roleIdsItem) {
  ...
  **/
  ...
  public UsersCreateNewUserRequest mobileNumber(String mobileNumber) {
  ...
  **/
  ...
  public UsersCreateNewUserRequest homeNumber(String homeNumber) {
  ...
  **/
  ...
  public UsersCreateNewUserRequest address(String address) {
  ...
  **/
  ...
  public UsersCreateNewUserRequest postalZip(String postalZip) {
  ...
  **/
  ...
  public UsersCreateNewUserRequest city(String city) {
  ...
  **/
  ...
  public UsersCreateNewUserRequest provState(String provState) {
  ...
  **/
  ...
  public UsersCreateNewUserRequest inviteUser(Boolean inviteUser) {
  ...
  **/
  ...
  public UsersCreateNewUserRequest notes(String notes) {
  ...
  **/
  ...
  public UsersCreateNewUserRequest hireDate(LocalDate hireDate) {
  ...
  **/
  ...
  public UsersCreateNewUserRequest type(TypeEnum type) {
  ...
  **/
  ...
  public UsersCreateNewUserRequest employeeId(String employeeId) {
  ...
  **/
  ...
  public UsersCreateNewUserRequest punchId(String punchId) {
  ...
  **/
  ...
  public UsersCreateNewUserRequest birthDate(LocalDate birthDate) {
  ...
  **/
  ...
  public UsersCreateNewUserRequest language(LanguageEnum language) {
  ...
  **/
  ...
  public UsersCreateNewUserRequest appearAsEmployee(Boolean appearAsEmployee) {
  ...
  **/
  ...
  public UsersCreateNewUserRequest subscribeToUpdates(Boolean subscribeToUpdates) {
  ...
  **/
  ...
  public UsersCreateNewUserRequest maxWeeklyHours(Integer maxWeeklyHours) {
  ...
  **/
  ...
  public UsersCreateNewUserRequest wageCents(Double wageCents) {
  ...
  public UsersCreateNewUserRequest wageCents(Integer wageCents) {
  ...
  **/
  ...
  public UsersCreateNewUserRequest wageType(WageTypeEnum wageType) {
  ...
  **/
  ...
  public UsersCreateNewUserRequest wages(List<UsersCreateNewUserRequestWagesInner> wages) {
  ...
  public UsersCreateNewUserRequest addWagesItem(UsersCreateNewUserRequestWagesInner wagesItem) {
    if (this.wages == null) {
  ...
  **/
  ...
  public List<UsersCreateNewUserRequestWagesInner> getWages() {
    return wages;
  }


  public void setWages(List<UsersCreateNewUserRequestWagesInner> wages) {
  ...
  public UsersCreateNewUserRequest permissionsTemplateId(Integer permissionsTemplateId) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.firstName, usersCreateNewUserRequest.firstName) &&
        ...
        Objects.equals(this.preferredFirstName, usersCreateNewUserRequest.preferredFirstName) &&
        Objects.equals(this.preferredLastName, usersCreateNewUserRequest.preferredLastName) &&
        Objects.equals(this.locationIds, usersCreateNewUserRequest.locationIds) &&
        Objects.equals(this.departmentIds, usersCreateNewUserRequest.departmentIds) &&
        Objects.equals(this.roleIds, usersCreateNewUserRequest.roleIds) &&
        Objects.equals(this.email, usersCreateNewUserRequest.email) &&
        Objects.equals(this.mobileNumber, usersCreateNewUserRequest.mobileNumber) &&
        Objects.equals(this.homeNumber, usersCreateNewUserRequest.homeNumber) &&
        Objects.equals(this.address, usersCreateNewUserRequest.address) &&
        Objects.equals(this.postalZip, usersCreateNewUserRequest.postalZip) &&
        Objects.equals(this.city, usersCreateNewUserRequest.city) &&
        Objects.equals(this.provState, usersCreateNewUserRequest.provState) &&
        Objects.equals(this.inviteUser, usersCreateNewUserRequest.inviteUser) &&
        Objects.equals(this.notes, usersCreateNewUserRequest.notes) &&
        Objects.equals(this.hireDate, usersCreateNewUserRequest.hireDate) &&
        Objects.equals(this.type, usersCreateNewUserRequest.type) &&
        Objects.equals(this.employeeId, usersCreateNewUserRequest.employeeId) &&
        Objects.equals(this.punchId, usersCreateNewUserRequest.punchId) &&
        Objects.equals(this.birthDate, usersCreateNewUserRequest.birthDate) &&
        Objects.equals(this.language, usersCreateNewUserRequest.language) &&
        Objects.equals(this.appearAsEmployee, usersCreateNewUserRequest.appearAsEmployee) &&
        Objects.equals(this.subscribeToUpdates, usersCreateNewUserRequest.subscribeToUpdates) &&
        Objects.equals(this.maxWeeklyHours, usersCreateNewUserRequest.maxWeeklyHours) &&
        Objects.equals(this.wageCents, usersCreateNewUserRequest.wageCents) &&
        Objects.equals(this.wageType, usersCreateNewUserRequest.wageType) &&
        Objects.equals(this.wages, usersCreateNewUserRequest.wages) &&
        Objects.equals(this.permissionsTemplateId, usersCreateNewUserRequest.permissionsTemplateId)&&
      ...
      if (jsonObj.get("wages") != null && !jsonObj.get("wages").isJsonNull()) {
        ...
        if (jsonArraywages != null) {
          ...
          for (int i = 0; i < jsonArraywages.size(); i++) {
            UsersCreateNewUserRequestWagesInner.validateJsonObject(jsonArraywages.get(i).getAsJsonObject());
          };
        }
      }
  }
