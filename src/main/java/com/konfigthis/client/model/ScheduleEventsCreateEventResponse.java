...
public class ScheduleEventsCreateEventResponse {
 ...
 public enum EventTypeEnum {
  ...
  public ScheduleEventsCreateEventResponse() {
  }

  public ScheduleEventsCreateEventResponse id(Integer id) {
  ...
  **/
  ...
  public ScheduleEventsCreateEventResponse eventType(EventTypeEnum eventType) {
  ...
  **/
  ...
  public ScheduleEventsCreateEventResponse title(String title) {
  ...
  **/
  ...
  public ScheduleEventsCreateEventResponse description(String description) {
  ...
  **/
  ...
  public ScheduleEventsCreateEventResponse locationIds(List<Integer> locationIds) {
  ...
  public ScheduleEventsCreateEventResponse addLocationIdsItem(Integer locationIdsItem) {
  ...
  **/
  ...
  public ScheduleEventsCreateEventResponse start(List<ScheduleEventsCreateEventResponseAllOf1Start> start) {
  ...
  public ScheduleEventsCreateEventResponse addStartItem(ScheduleEventsCreateEventResponseAllOf1Start startItem) {
    if (this.start == null) {
  ...
  **/
  ...
  public ScheduleEventsCreateEventResponse startDate(String startDate) {
  ...
  **/
  ...
  public ScheduleEventsCreateEventResponse startTime(String startTime) {
  ...
  **/
  ...
  public ScheduleEventsCreateEventResponse end(List<ScheduleEventsCreateEventResponseAllOf1End> end) {
  ...
  public ScheduleEventsCreateEventResponse addEndItem(ScheduleEventsCreateEventResponseAllOf1End endItem) {
    if (this.end == null) {
  ...
  **/
  ...
  public ScheduleEventsCreateEventResponse endDate(String endDate) {
  ...
  **/
  ...
  public ScheduleEventsCreateEventResponse endTime(String endTime) {
  ...
  **/
  ...
  public ScheduleEventsCreateEventResponse color(String color) {
  ...
  **/
  ...
  public ScheduleEventsCreateEventResponse isMultiDay(Boolean isMultiDay) {
  ...
  **/
  ...
  public ScheduleEventsCreateEventResponse recurrence(String recurrence) {
  ...
  **/
   ...
   * @return the ScheduleEventsCreateEventResponse instance itself
   */
  public ScheduleEventsCreateEventResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ScheduleEventsCreateEventResponse scheduleEventsCreateEventResponse = (ScheduleEventsCreateEventResponse) o;
    return Objects.equals(this.id, scheduleEventsCreateEventResponse.id) &&
        Objects.equals(this.eventType, scheduleEventsCreateEventResponse.eventType) &&
        Objects.equals(this.title, scheduleEventsCreateEventResponse.title) &&
        Objects.equals(this.description, scheduleEventsCreateEventResponse.description) &&
        Objects.equals(this.locationIds, scheduleEventsCreateEventResponse.locationIds) &&
        Objects.equals(this.start, scheduleEventsCreateEventResponse.start) &&
        Objects.equals(this.startDate, scheduleEventsCreateEventResponse.startDate) &&
        Objects.equals(this.startTime, scheduleEventsCreateEventResponse.startTime) &&
        Objects.equals(this.end, scheduleEventsCreateEventResponse.end) &&
        Objects.equals(this.endDate, scheduleEventsCreateEventResponse.endDate) &&
        Objects.equals(this.endTime, scheduleEventsCreateEventResponse.endTime) &&
        Objects.equals(this.color, scheduleEventsCreateEventResponse.color) &&
        Objects.equals(this.isMultiDay, scheduleEventsCreateEventResponse.isMultiDay) &&
        Objects.equals(this.recurrence, scheduleEventsCreateEventResponse.recurrence)&&
        Objects.equals(this.additionalProperties, scheduleEventsCreateEventResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ScheduleEventsCreateEventResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ScheduleEventsCreateEventResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ScheduleEventsCreateEventResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ScheduleEventsCreateEventResponse is not found in the empty JSON string", ScheduleEventsCreateEventResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ScheduleEventsCreateEventResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ScheduleEventsCreateEventResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ScheduleEventsCreateEventResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ScheduleEventsCreateEventResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ScheduleEventsCreateEventResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ScheduleEventsCreateEventResponse>() {
           @Override
           public void write(JsonWriter out, ScheduleEventsCreateEventResponse value) throws IOException {
           ...
           @Override
           public ScheduleEventsCreateEventResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ScheduleEventsCreateEventResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ScheduleEventsCreateEventResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ScheduleEventsCreateEventResponse
  * @throws IOException if the JSON string is invalid with respect to ScheduleEventsCreateEventResponse
  */
  public static ScheduleEventsCreateEventResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ScheduleEventsCreateEventResponse.class);
  }

 /**
  * Convert an instance of ScheduleEventsCreateEventResponse to an JSON string
  *
  * @return JSON string
  */
