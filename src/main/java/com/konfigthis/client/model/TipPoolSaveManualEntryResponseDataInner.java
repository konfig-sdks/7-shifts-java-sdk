...
public class TipPoolSaveManualEntryResponseDataInner {
  ...
  public TipPoolSaveManualEntryResponseDataInner() {
  }

  public TipPoolSaveManualEntryResponseDataInner uuid(UUID uuid) {
  ...
  **/
  ...
  public TipPoolSaveManualEntryResponseDataInner tipPoolSettingsUuid(UUID tipPoolSettingsUuid) {
  ...
  **/
  ...
  public TipPoolSaveManualEntryResponseDataInner dayPartUuid(UUID dayPartUuid) {
  ...
  **/
  ...
  public TipPoolSaveManualEntryResponseDataInner entryDate(String entryDate) {
  ...
  **/
  ...
  public TipPoolSaveManualEntryResponseDataInner tipAmount(Float tipAmount) {
  ...
  **/
  ...
  public TipPoolSaveManualEntryResponseDataInner created(String created) {
  ...
  **/
  ...
  public TipPoolSaveManualEntryResponseDataInner modified(String modified) {
  ...
  **/
   ...
   * @return the TipPoolSaveManualEntryResponseDataInner instance itself
   */
  public TipPoolSaveManualEntryResponseDataInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    TipPoolSaveManualEntryResponseDataInner tipPoolSaveManualEntryResponseDataInner = (TipPoolSaveManualEntryResponseDataInner) o;
    return Objects.equals(this.uuid, tipPoolSaveManualEntryResponseDataInner.uuid) &&
        Objects.equals(this.tipPoolSettingsUuid, tipPoolSaveManualEntryResponseDataInner.tipPoolSettingsUuid) &&
        Objects.equals(this.dayPartUuid, tipPoolSaveManualEntryResponseDataInner.dayPartUuid) &&
        Objects.equals(this.entryDate, tipPoolSaveManualEntryResponseDataInner.entryDate) &&
        Objects.equals(this.tipAmount, tipPoolSaveManualEntryResponseDataInner.tipAmount) &&
        Objects.equals(this.created, tipPoolSaveManualEntryResponseDataInner.created) &&
        Objects.equals(this.modified, tipPoolSaveManualEntryResponseDataInner.modified)&&
        Objects.equals(this.additionalProperties, tipPoolSaveManualEntryResponseDataInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class TipPoolSaveManualEntryResponseDataInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to TipPoolSaveManualEntryResponseDataInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TipPoolSaveManualEntryResponseDataInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TipPoolSaveManualEntryResponseDataInner is not found in the empty JSON string", TipPoolSaveManualEntryResponseDataInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TipPoolSaveManualEntryResponseDataInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TipPoolSaveManualEntryResponseDataInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TipPoolSaveManualEntryResponseDataInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TipPoolSaveManualEntryResponseDataInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TipPoolSaveManualEntryResponseDataInner.class));

       return (TypeAdapter<T>) new TypeAdapter<TipPoolSaveManualEntryResponseDataInner>() {
           @Override
           public void write(JsonWriter out, TipPoolSaveManualEntryResponseDataInner value) throws IOException {
           ...
           @Override
           public TipPoolSaveManualEntryResponseDataInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             TipPoolSaveManualEntryResponseDataInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of TipPoolSaveManualEntryResponseDataInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of TipPoolSaveManualEntryResponseDataInner
  * @throws IOException if the JSON string is invalid with respect to TipPoolSaveManualEntryResponseDataInner
  */
  public static TipPoolSaveManualEntryResponseDataInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TipPoolSaveManualEntryResponseDataInner.class);
  }

 /**
  * Convert an instance of TipPoolSaveManualEntryResponseDataInner to an JSON string
  *
  * @return JSON string
  */
