...
import com.konfigthis.client.model.TimePunchesListResponseDataInnerBreaksInner;
...
public class TimePunchesListResponseDataInner {
  ...
  private List<TimePunchesListResponseDataInnerBreaksInner> breaks = null;
  ...
  public TimePunchesListResponseDataInner() {
  }

  public TimePunchesListResponseDataInner id(Integer id) {
  ...
  **/
  ...
  public TimePunchesListResponseDataInner shiftId(Integer shiftId) {
  ...
  **/
  ...
  public TimePunchesListResponseDataInner userId(Integer userId) {
  ...
  **/
  ...
  public TimePunchesListResponseDataInner editablePunch(Boolean editablePunch) {
  ...
  **/
  ...
  public TimePunchesListResponseDataInner roleId(Integer roleId) {
  ...
  **/
  ...
  public TimePunchesListResponseDataInner companyId(Integer companyId) {
  ...
  **/
  ...
  public TimePunchesListResponseDataInner locationId(Integer locationId) {
  ...
  **/
  ...
  public TimePunchesListResponseDataInner departmentId(Integer departmentId) {
  ...
  **/
  ...
  public TimePunchesListResponseDataInner hourlyWage(Integer hourlyWage) {
  ...
  **/
  ...
  public TimePunchesListResponseDataInner approved(Boolean approved) {
  ...
  **/
  ...
  public TimePunchesListResponseDataInner clockedIn(OffsetDateTime clockedIn) {
  ...
  **/
  ...
  public TimePunchesListResponseDataInner clockedOut(OffsetDateTime clockedOut) {
  ...
  **/
  ...
  public TimePunchesListResponseDataInner notes(String notes) {
  ...
  **/
  ...
  public TimePunchesListResponseDataInner autoClockedOut(Boolean autoClockedOut) {
  ...
  **/
  ...
  public TimePunchesListResponseDataInner clockedInOffline(Boolean clockedInOffline) {
  ...
  **/
  ...
  public TimePunchesListResponseDataInner clockedOutOffline(Boolean clockedOutOffline) {
  ...
  **/
  ...
  public TimePunchesListResponseDataInner tips(Integer tips) {
  ...
  **/
  ...
  public TimePunchesListResponseDataInner posType(String posType) {
  ...
  **/
  ...
  public TimePunchesListResponseDataInner breaks(List<TimePunchesListResponseDataInnerBreaksInner> breaks) {
  ...
  public TimePunchesListResponseDataInner addBreaksItem(TimePunchesListResponseDataInnerBreaksInner breaksItem) {
    if (this.breaks == null) {
  ...
  **/
  ...
  public List<TimePunchesListResponseDataInnerBreaksInner> getBreaks() {
    return breaks;
  }


  public void setBreaks(List<TimePunchesListResponseDataInnerBreaksInner> breaks) {
  ...
  public TimePunchesListResponseDataInner created(OffsetDateTime created) {
  ...
  **/
  ...
  public TimePunchesListResponseDataInner modified(OffsetDateTime modified) {
  ...
  **/
  ...
  public TimePunchesListResponseDataInner deleted(Boolean deleted) {
  ...
  **/
   ...
   * @return the TimePunchesListResponseDataInner instance itself
   */
  public TimePunchesListResponseDataInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    TimePunchesListResponseDataInner timePunchesListResponseDataInner = (TimePunchesListResponseDataInner) o;
    return Objects.equals(this.id, timePunchesListResponseDataInner.id) &&
        Objects.equals(this.shiftId, timePunchesListResponseDataInner.shiftId) &&
        Objects.equals(this.userId, timePunchesListResponseDataInner.userId) &&
        Objects.equals(this.editablePunch, timePunchesListResponseDataInner.editablePunch) &&
        Objects.equals(this.roleId, timePunchesListResponseDataInner.roleId) &&
        Objects.equals(this.companyId, timePunchesListResponseDataInner.companyId) &&
        Objects.equals(this.locationId, timePunchesListResponseDataInner.locationId) &&
        Objects.equals(this.departmentId, timePunchesListResponseDataInner.departmentId) &&
        Objects.equals(this.hourlyWage, timePunchesListResponseDataInner.hourlyWage) &&
        Objects.equals(this.approved, timePunchesListResponseDataInner.approved) &&
        Objects.equals(this.clockedIn, timePunchesListResponseDataInner.clockedIn) &&
        Objects.equals(this.clockedOut, timePunchesListResponseDataInner.clockedOut) &&
        Objects.equals(this.notes, timePunchesListResponseDataInner.notes) &&
        Objects.equals(this.autoClockedOut, timePunchesListResponseDataInner.autoClockedOut) &&
        Objects.equals(this.clockedInOffline, timePunchesListResponseDataInner.clockedInOffline) &&
        Objects.equals(this.clockedOutOffline, timePunchesListResponseDataInner.clockedOutOffline) &&
        Objects.equals(this.tips, timePunchesListResponseDataInner.tips) &&
        Objects.equals(this.posType, timePunchesListResponseDataInner.posType) &&
        Objects.equals(this.breaks, timePunchesListResponseDataInner.breaks) &&
        Objects.equals(this.created, timePunchesListResponseDataInner.created) &&
        Objects.equals(this.modified, timePunchesListResponseDataInner.modified) &&
        Objects.equals(this.deleted, timePunchesListResponseDataInner.deleted)&&
        Objects.equals(this.additionalProperties, timePunchesListResponseDataInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class TimePunchesListResponseDataInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to TimePunchesListResponseDataInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TimePunchesListResponseDataInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TimePunchesListResponseDataInner is not found in the empty JSON string", TimePunchesListResponseDataInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TimePunchesListResponseDataInner.openapiRequiredFields) {
      ...
      if (jsonObj.get("breaks") != null && !jsonObj.get("breaks").isJsonNull()) {
        ...
        if (jsonArraybreaks != null) {
          ...
          for (int i = 0; i < jsonArraybreaks.size(); i++) {
            TimePunchesListResponseDataInnerBreaksInner.validateJsonObject(jsonArraybreaks.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TimePunchesListResponseDataInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TimePunchesListResponseDataInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TimePunchesListResponseDataInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TimePunchesListResponseDataInner.class));

       return (TypeAdapter<T>) new TypeAdapter<TimePunchesListResponseDataInner>() {
           @Override
           public void write(JsonWriter out, TimePunchesListResponseDataInner value) throws IOException {
           ...
           @Override
           public TimePunchesListResponseDataInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             TimePunchesListResponseDataInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of TimePunchesListResponseDataInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of TimePunchesListResponseDataInner
  * @throws IOException if the JSON string is invalid with respect to TimePunchesListResponseDataInner
  */
  public static TimePunchesListResponseDataInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TimePunchesListResponseDataInner.class);
  }

 /**
  * Convert an instance of TimePunchesListResponseDataInner to an JSON string
  *
  * @return JSON string
  */
