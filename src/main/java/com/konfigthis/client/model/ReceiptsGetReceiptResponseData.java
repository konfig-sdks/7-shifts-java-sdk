...
public class ReceiptsGetReceiptResponseData {
  ...
  private List<ReceiptsGetReceiptResponseDataReceiptLinesInner> receiptLines = null;

  public static final String SERIALIZED_NAME_TIP_DETAILS = "tip_details";
  @SerializedName(SERIALIZED_NAME_TIP_DETAILS)
  private List<ReceiptsGetReceiptResponseDataTipDetailsInner> tipDetails = null;
 ...
 public enum StatusEnum {
  ...
  public ReceiptsGetReceiptResponseData() {
  }

  public ReceiptsGetReceiptResponseData uuid(UUID uuid) {
  ...
  **/
  ...
  public ReceiptsGetReceiptResponseData companyId(Integer companyId) {
  ...
  **/
  ...
  public ReceiptsGetReceiptResponseData locationId(Integer locationId) {
  ...
  **/
  ...
  public ReceiptsGetReceiptResponseData posId(Integer posId) {
  ...
  **/
  ...
  public ReceiptsGetReceiptResponseData receiptId(String receiptId) {
  ...
  **/
  ...
  public ReceiptsGetReceiptResponseData receiptDate(OffsetDateTime receiptDate) {
  ...
  **/
  ...
  public ReceiptsGetReceiptResponseData receiptCloseDate(OffsetDateTime receiptCloseDate) {
  ...
  **/
  ...
  public ReceiptsGetReceiptResponseData netTotal(Integer netTotal) {
  ...
  **/
  ...
  public ReceiptsGetReceiptResponseData grossTotal(Integer grossTotal) {
  ...
  **/
  ...
  public ReceiptsGetReceiptResponseData tips(Integer tips) {
  ...
  **/
  ...
  public ReceiptsGetReceiptResponseData totalReceiptDiscounts(Integer totalReceiptDiscounts) {
  ...
  **/
  ...
  public ReceiptsGetReceiptResponseData totalItemDiscounts(Integer totalItemDiscounts) {
  ...
  **/
  ...
  public ReceiptsGetReceiptResponseData externalUserId(String externalUserId) {
  ...
  **/
  ...
  public ReceiptsGetReceiptResponseData revenueCenter(String revenueCenter) {
  ...
  **/
  ...
  public ReceiptsGetReceiptResponseData receiptLines(List<ReceiptsGetReceiptResponseDataReceiptLinesInner> receiptLines) {
  ...
  public ReceiptsGetReceiptResponseData addReceiptLinesItem(ReceiptsGetReceiptResponseDataReceiptLinesInner receiptLinesItem) {
  ...
  **/
  ...
  public List<ReceiptsGetReceiptResponseDataReceiptLinesInner> getReceiptLines() {
    return receiptLines;
  }


  public void setReceiptLines(List<ReceiptsGetReceiptResponseDataReceiptLinesInner> receiptLines) {
  ...
  public ReceiptsGetReceiptResponseData tipDetails(List<ReceiptsGetReceiptResponseDataTipDetailsInner> tipDetails) {
  ...
  public ReceiptsGetReceiptResponseData addTipDetailsItem(ReceiptsGetReceiptResponseDataTipDetailsInner tipDetailsItem) {
  ...
  **/
  ...
  public List<ReceiptsGetReceiptResponseDataTipDetailsInner> getTipDetails() {
    return tipDetails;
  }


  public void setTipDetails(List<ReceiptsGetReceiptResponseDataTipDetailsInner> tipDetails) {
  ...
  public ReceiptsGetReceiptResponseData status(StatusEnum status) {
  ...
  **/
  ...
  public ReceiptsGetReceiptResponseData createdDate(OffsetDateTime createdDate) {
  ...
  **/
  ...
  public ReceiptsGetReceiptResponseData modifiedDate(OffsetDateTime modifiedDate) {
  ...
  **/
   ...
   * @return the ReceiptsGetReceiptResponseData instance itself
   */
  public ReceiptsGetReceiptResponseData putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ReceiptsGetReceiptResponseData receiptsGetReceiptResponseData = (ReceiptsGetReceiptResponseData) o;
    return Objects.equals(this.uuid, receiptsGetReceiptResponseData.uuid) &&
        Objects.equals(this.companyId, receiptsGetReceiptResponseData.companyId) &&
        Objects.equals(this.locationId, receiptsGetReceiptResponseData.locationId) &&
        Objects.equals(this.posId, receiptsGetReceiptResponseData.posId) &&
        Objects.equals(this.receiptId, receiptsGetReceiptResponseData.receiptId) &&
        Objects.equals(this.receiptDate, receiptsGetReceiptResponseData.receiptDate) &&
        Objects.equals(this.receiptCloseDate, receiptsGetReceiptResponseData.receiptCloseDate) &&
        Objects.equals(this.netTotal, receiptsGetReceiptResponseData.netTotal) &&
        Objects.equals(this.grossTotal, receiptsGetReceiptResponseData.grossTotal) &&
        Objects.equals(this.tips, receiptsGetReceiptResponseData.tips) &&
        Objects.equals(this.totalReceiptDiscounts, receiptsGetReceiptResponseData.totalReceiptDiscounts) &&
        Objects.equals(this.totalItemDiscounts, receiptsGetReceiptResponseData.totalItemDiscounts) &&
        Objects.equals(this.externalUserId, receiptsGetReceiptResponseData.externalUserId) &&
        Objects.equals(this.revenueCenter, receiptsGetReceiptResponseData.revenueCenter) &&
        Objects.equals(this.receiptLines, receiptsGetReceiptResponseData.receiptLines) &&
        Objects.equals(this.tipDetails, receiptsGetReceiptResponseData.tipDetails) &&
        Objects.equals(this.status, receiptsGetReceiptResponseData.status) &&
        Objects.equals(this.createdDate, receiptsGetReceiptResponseData.createdDate) &&
        Objects.equals(this.modifiedDate, receiptsGetReceiptResponseData.modifiedDate)&&
        Objects.equals(this.additionalProperties, receiptsGetReceiptResponseData.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ReceiptsGetReceiptResponseData {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ReceiptsGetReceiptResponseData
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ReceiptsGetReceiptResponseData.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ReceiptsGetReceiptResponseData is not found in the empty JSON string", ReceiptsGetReceiptResponseData.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ReceiptsGetReceiptResponseData.openapiRequiredFields) {
      ...
      if (jsonObj.get("receipt_lines") != null && !jsonObj.get("receipt_lines").isJsonNull()) {
        ...
        if (jsonArrayreceiptLines != null) {
          ...
          for (int i = 0; i < jsonArrayreceiptLines.size(); i++) {
            ReceiptsGetReceiptResponseDataReceiptLinesInner.validateJsonObject(jsonArrayreceiptLines.get(i).getAsJsonObject());
          };
        }
      }
      if (jsonObj.get("tip_details") != null && !jsonObj.get("tip_details").isJsonNull()) {
        ...
        if (jsonArraytipDetails != null) {
          ...
          for (int i = 0; i < jsonArraytipDetails.size(); i++) {
            ReceiptsGetReceiptResponseDataTipDetailsInner.validateJsonObject(jsonArraytipDetails.get(i).getAsJsonObject());
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ReceiptsGetReceiptResponseData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ReceiptsGetReceiptResponseData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ReceiptsGetReceiptResponseData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ReceiptsGetReceiptResponseData.class));

       return (TypeAdapter<T>) new TypeAdapter<ReceiptsGetReceiptResponseData>() {
           @Override
           public void write(JsonWriter out, ReceiptsGetReceiptResponseData value) throws IOException {
           ...
           @Override
           public ReceiptsGetReceiptResponseData read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ReceiptsGetReceiptResponseData instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ReceiptsGetReceiptResponseData given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ReceiptsGetReceiptResponseData
  * @throws IOException if the JSON string is invalid with respect to ReceiptsGetReceiptResponseData
  */
  public static ReceiptsGetReceiptResponseData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ReceiptsGetReceiptResponseData.class);
  }

 /**
  * Convert an instance of ReceiptsGetReceiptResponseData to an JSON string
  *
  * @return JSON string
  */
