...
import com.konfigthis.client.model.TimePunchesUpdateByIdResponseDataBreaksInner;
...
public class TimePunchesUpdateByIdResponseData {
  ...
  private List<TimePunchesUpdateByIdResponseDataBreaksInner> breaks = null;
  ...
  public TimePunchesUpdateByIdResponseData() {
  }

  public TimePunchesUpdateByIdResponseData id(Integer id) {
  ...
  **/
  ...
  public TimePunchesUpdateByIdResponseData shiftId(Integer shiftId) {
  ...
  **/
  ...
  public TimePunchesUpdateByIdResponseData userId(Integer userId) {
  ...
  **/
  ...
  public TimePunchesUpdateByIdResponseData editablePunch(Boolean editablePunch) {
  ...
  **/
  ...
  public TimePunchesUpdateByIdResponseData roleId(Integer roleId) {
  ...
  **/
  ...
  public TimePunchesUpdateByIdResponseData companyId(Integer companyId) {
  ...
  **/
  ...
  public TimePunchesUpdateByIdResponseData locationId(Integer locationId) {
  ...
  **/
  ...
  public TimePunchesUpdateByIdResponseData departmentId(Integer departmentId) {
  ...
  **/
  ...
  public TimePunchesUpdateByIdResponseData hourlyWage(Integer hourlyWage) {
  ...
  **/
  ...
  public TimePunchesUpdateByIdResponseData approved(Boolean approved) {
  ...
  **/
  ...
  public TimePunchesUpdateByIdResponseData clockedIn(OffsetDateTime clockedIn) {
  ...
  **/
  ...
  public TimePunchesUpdateByIdResponseData clockedOut(OffsetDateTime clockedOut) {
  ...
  **/
  ...
  public TimePunchesUpdateByIdResponseData notes(String notes) {
  ...
  **/
  ...
  public TimePunchesUpdateByIdResponseData autoClockedOut(Boolean autoClockedOut) {
  ...
  **/
  ...
  public TimePunchesUpdateByIdResponseData clockedInOffline(Boolean clockedInOffline) {
  ...
  **/
  ...
  public TimePunchesUpdateByIdResponseData clockedOutOffline(Boolean clockedOutOffline) {
  ...
  **/
  ...
  public TimePunchesUpdateByIdResponseData tips(Integer tips) {
  ...
  **/
  ...
  public TimePunchesUpdateByIdResponseData posType(String posType) {
  ...
  **/
  ...
  public TimePunchesUpdateByIdResponseData breaks(List<TimePunchesUpdateByIdResponseDataBreaksInner> breaks) {
  ...
  public TimePunchesUpdateByIdResponseData addBreaksItem(TimePunchesUpdateByIdResponseDataBreaksInner breaksItem) {
    if (this.breaks == null) {
  ...
  **/
  ...
  public List<TimePunchesUpdateByIdResponseDataBreaksInner> getBreaks() {
    return breaks;
  }


  public void setBreaks(List<TimePunchesUpdateByIdResponseDataBreaksInner> breaks) {
  ...
  public TimePunchesUpdateByIdResponseData created(OffsetDateTime created) {
  ...
  **/
  ...
  public TimePunchesUpdateByIdResponseData modified(OffsetDateTime modified) {
  ...
  **/
  ...
  public TimePunchesUpdateByIdResponseData deleted(Boolean deleted) {
  ...
  **/
   ...
   * @return the TimePunchesUpdateByIdResponseData instance itself
   */
  public TimePunchesUpdateByIdResponseData putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    TimePunchesUpdateByIdResponseData timePunchesUpdateByIdResponseData = (TimePunchesUpdateByIdResponseData) o;
    return Objects.equals(this.id, timePunchesUpdateByIdResponseData.id) &&
        Objects.equals(this.shiftId, timePunchesUpdateByIdResponseData.shiftId) &&
        Objects.equals(this.userId, timePunchesUpdateByIdResponseData.userId) &&
        Objects.equals(this.editablePunch, timePunchesUpdateByIdResponseData.editablePunch) &&
        Objects.equals(this.roleId, timePunchesUpdateByIdResponseData.roleId) &&
        Objects.equals(this.companyId, timePunchesUpdateByIdResponseData.companyId) &&
        Objects.equals(this.locationId, timePunchesUpdateByIdResponseData.locationId) &&
        Objects.equals(this.departmentId, timePunchesUpdateByIdResponseData.departmentId) &&
        Objects.equals(this.hourlyWage, timePunchesUpdateByIdResponseData.hourlyWage) &&
        Objects.equals(this.approved, timePunchesUpdateByIdResponseData.approved) &&
        Objects.equals(this.clockedIn, timePunchesUpdateByIdResponseData.clockedIn) &&
        Objects.equals(this.clockedOut, timePunchesUpdateByIdResponseData.clockedOut) &&
        Objects.equals(this.notes, timePunchesUpdateByIdResponseData.notes) &&
        Objects.equals(this.autoClockedOut, timePunchesUpdateByIdResponseData.autoClockedOut) &&
        Objects.equals(this.clockedInOffline, timePunchesUpdateByIdResponseData.clockedInOffline) &&
        Objects.equals(this.clockedOutOffline, timePunchesUpdateByIdResponseData.clockedOutOffline) &&
        Objects.equals(this.tips, timePunchesUpdateByIdResponseData.tips) &&
        Objects.equals(this.posType, timePunchesUpdateByIdResponseData.posType) &&
        Objects.equals(this.breaks, timePunchesUpdateByIdResponseData.breaks) &&
        Objects.equals(this.created, timePunchesUpdateByIdResponseData.created) &&
        Objects.equals(this.modified, timePunchesUpdateByIdResponseData.modified) &&
        Objects.equals(this.deleted, timePunchesUpdateByIdResponseData.deleted)&&
        Objects.equals(this.additionalProperties, timePunchesUpdateByIdResponseData.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class TimePunchesUpdateByIdResponseData {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to TimePunchesUpdateByIdResponseData
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TimePunchesUpdateByIdResponseData.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TimePunchesUpdateByIdResponseData is not found in the empty JSON string", TimePunchesUpdateByIdResponseData.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TimePunchesUpdateByIdResponseData.openapiRequiredFields) {
      ...
      if (jsonObj.get("breaks") != null && !jsonObj.get("breaks").isJsonNull()) {
        ...
        if (jsonArraybreaks != null) {
          ...
          for (int i = 0; i < jsonArraybreaks.size(); i++) {
            TimePunchesUpdateByIdResponseDataBreaksInner.validateJsonObject(jsonArraybreaks.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TimePunchesUpdateByIdResponseData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TimePunchesUpdateByIdResponseData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TimePunchesUpdateByIdResponseData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TimePunchesUpdateByIdResponseData.class));

       return (TypeAdapter<T>) new TypeAdapter<TimePunchesUpdateByIdResponseData>() {
           @Override
           public void write(JsonWriter out, TimePunchesUpdateByIdResponseData value) throws IOException {
           ...
           @Override
           public TimePunchesUpdateByIdResponseData read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             TimePunchesUpdateByIdResponseData instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of TimePunchesUpdateByIdResponseData given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of TimePunchesUpdateByIdResponseData
  * @throws IOException if the JSON string is invalid with respect to TimePunchesUpdateByIdResponseData
  */
  public static TimePunchesUpdateByIdResponseData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TimePunchesUpdateByIdResponseData.class);
  }

 /**
  * Convert an instance of TimePunchesUpdateByIdResponseData to an JSON string
  *
  * @return JSON string
  */
