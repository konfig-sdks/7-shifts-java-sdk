...
public class ReceiptsCreateReceiptRequest {
 ...
 public enum OrderTypeEnum {
  ...
  public ReceiptsCreateReceiptRequest() {
  }

  public ReceiptsCreateReceiptRequest receiptId(String receiptId) {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "ID available to the client in the POS UI. Be it a GUID, a receipt number, a composite of date and ID and terminal, etc")
  ...
  public ReceiptsCreateReceiptRequest locationId(Integer locationId) {
  ...
  **/
  ...
  public ReceiptsCreateReceiptRequest receiptDate(OffsetDateTime receiptDate) {
  ...
  **/
  ...
  public ReceiptsCreateReceiptRequest netTotal(Integer netTotal) {
  ...
  **/
  ...
  public ReceiptsCreateReceiptRequest grossTotal(Integer grossTotal) {
  ...
  **/
  ...
  public ReceiptsCreateReceiptRequest totalReceiptDiscounts(Integer totalReceiptDiscounts) {
  ...
  **/
  ...
  public ReceiptsCreateReceiptRequest tips(Integer tips) {
  ...
  **/
  ...
  public ReceiptsCreateReceiptRequest externalUserId(String externalUserId) {
  ...
  **/
  ...
  public ReceiptsCreateReceiptRequest revenueCenter(String revenueCenter) {
  ...
  **/
  ...
  public ReceiptsCreateReceiptRequest receiptLines(List<ReceiptsCreateReceiptRequestAllOfReceiptLines> receiptLines) {
  ...
  public ReceiptsCreateReceiptRequest addReceiptLinesItem(ReceiptsCreateReceiptRequestAllOfReceiptLines receiptLinesItem) {
  ...
  **/
  ...
  public ReceiptsCreateReceiptRequest tipDetails(List<ReceiptsCreateReceiptRequestAllOfTipDetails> tipDetails) {
  ...
  public ReceiptsCreateReceiptRequest addTipDetailsItem(ReceiptsCreateReceiptRequestAllOfTipDetails tipDetailsItem) {
  ...
  **/
  ...
  public ReceiptsCreateReceiptRequest status(StatusEnum status) {
  ...
  **/
  ...
  public ReceiptsCreateReceiptRequest orderType(OrderTypeEnum orderType) {
  ...
  **/
  ...
  public ReceiptsCreateReceiptRequest diningOption(String diningOption) {
  ...
  **/
   ...
   * @return the ReceiptsCreateReceiptRequest instance itself
   */
  public ReceiptsCreateReceiptRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ReceiptsCreateReceiptRequest receiptsCreateReceiptRequest = (ReceiptsCreateReceiptRequest) o;
    return Objects.equals(this.receiptId, receiptsCreateReceiptRequest.receiptId) &&
        Objects.equals(this.locationId, receiptsCreateReceiptRequest.locationId) &&
        Objects.equals(this.receiptDate, receiptsCreateReceiptRequest.receiptDate) &&
        Objects.equals(this.netTotal, receiptsCreateReceiptRequest.netTotal) &&
        Objects.equals(this.grossTotal, receiptsCreateReceiptRequest.grossTotal) &&
        Objects.equals(this.totalReceiptDiscounts, receiptsCreateReceiptRequest.totalReceiptDiscounts) &&
        Objects.equals(this.tips, receiptsCreateReceiptRequest.tips) &&
        Objects.equals(this.externalUserId, receiptsCreateReceiptRequest.externalUserId) &&
        Objects.equals(this.revenueCenter, receiptsCreateReceiptRequest.revenueCenter) &&
        Objects.equals(this.receiptLines, receiptsCreateReceiptRequest.receiptLines) &&
        Objects.equals(this.tipDetails, receiptsCreateReceiptRequest.tipDetails) &&
        Objects.equals(this.status, receiptsCreateReceiptRequest.status) &&
        Objects.equals(this.orderType, receiptsCreateReceiptRequest.orderType) &&
        Objects.equals(this.diningOption, receiptsCreateReceiptRequest.diningOption)&&
        Objects.equals(this.additionalProperties, receiptsCreateReceiptRequest.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(receiptId, locationId, receiptDate, netTotal, grossTotal, totalReceiptDiscounts, tips, externalUserId, revenueCenter, receiptLines, tipDetails, status, orderType, diningOption, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ReceiptsCreateReceiptRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ReceiptsCreateReceiptRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ReceiptsCreateReceiptRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ReceiptsCreateReceiptRequest is not found in the empty JSON string", ReceiptsCreateReceiptRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ReceiptsCreateReceiptRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ReceiptsCreateReceiptRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ReceiptsCreateReceiptRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ReceiptsCreateReceiptRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ReceiptsCreateReceiptRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ReceiptsCreateReceiptRequest>() {
           @Override
           public void write(JsonWriter out, ReceiptsCreateReceiptRequest value) throws IOException {
           ...
           @Override
           public ReceiptsCreateReceiptRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ReceiptsCreateReceiptRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ReceiptsCreateReceiptRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ReceiptsCreateReceiptRequest
  * @throws IOException if the JSON string is invalid with respect to ReceiptsCreateReceiptRequest
  */
  public static ReceiptsCreateReceiptRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ReceiptsCreateReceiptRequest.class);
  }

 /**
  * Convert an instance of ReceiptsCreateReceiptRequest to an JSON string
  *
  * @return JSON string
  */
