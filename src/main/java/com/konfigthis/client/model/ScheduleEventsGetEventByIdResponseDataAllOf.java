...
public class ScheduleEventsGetEventByIdResponseDataAllOf {
  ...
  public ScheduleEventsGetEventByIdResponseDataAllOf() {
  }

  public ScheduleEventsGetEventByIdResponseDataAllOf title(String title) {
  ...
  **/
  ...
  public ScheduleEventsGetEventByIdResponseDataAllOf description(String description) {
  ...
  **/
  ...
  public ScheduleEventsGetEventByIdResponseDataAllOf locationIds(List<Integer> locationIds) {
  ...
  public ScheduleEventsGetEventByIdResponseDataAllOf addLocationIdsItem(Integer locationIdsItem) {
  ...
  **/
  ...
  public ScheduleEventsGetEventByIdResponseDataAllOf start(List<ScheduleEventsListEventsResponseDataInnerAllOf1StartInner> start) {
  ...
  public ScheduleEventsGetEventByIdResponseDataAllOf addStartItem(ScheduleEventsListEventsResponseDataInnerAllOf1StartInner startItem) {
    if (this.start == null) {
  ...
  **/
  ...
  public ScheduleEventsGetEventByIdResponseDataAllOf startDate(String startDate) {
  ...
  **/
  ...
  public ScheduleEventsGetEventByIdResponseDataAllOf startTime(String startTime) {
  ...
  **/
  ...
  public ScheduleEventsGetEventByIdResponseDataAllOf end(List<ScheduleEventsListEventsResponseDataInnerAllOf1EndInner> end) {
  ...
  public ScheduleEventsGetEventByIdResponseDataAllOf addEndItem(ScheduleEventsListEventsResponseDataInnerAllOf1EndInner endItem) {
    if (this.end == null) {
  ...
  **/
  ...
  public ScheduleEventsGetEventByIdResponseDataAllOf endDate(String endDate) {
  ...
  **/
  ...
  public ScheduleEventsGetEventByIdResponseDataAllOf endTime(String endTime) {
  ...
  **/
  ...
  public ScheduleEventsGetEventByIdResponseDataAllOf color(String color) {
  ...
  **/
  ...
  public ScheduleEventsGetEventByIdResponseDataAllOf isMultiDay(Boolean isMultiDay) {
  ...
  **/
  ...
  public ScheduleEventsGetEventByIdResponseDataAllOf recurrence(String recurrence) {
  ...
  **/
   ...
   * @return the ScheduleEventsGetEventByIdResponseDataAllOf instance itself
   */
  public ScheduleEventsGetEventByIdResponseDataAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ScheduleEventsGetEventByIdResponseDataAllOf scheduleEventsGetEventByIdResponseDataAllOf = (ScheduleEventsGetEventByIdResponseDataAllOf) o;
    return Objects.equals(this.title, scheduleEventsGetEventByIdResponseDataAllOf.title) &&
        Objects.equals(this.description, scheduleEventsGetEventByIdResponseDataAllOf.description) &&
        Objects.equals(this.locationIds, scheduleEventsGetEventByIdResponseDataAllOf.locationIds) &&
        Objects.equals(this.start, scheduleEventsGetEventByIdResponseDataAllOf.start) &&
        Objects.equals(this.startDate, scheduleEventsGetEventByIdResponseDataAllOf.startDate) &&
        Objects.equals(this.startTime, scheduleEventsGetEventByIdResponseDataAllOf.startTime) &&
        Objects.equals(this.end, scheduleEventsGetEventByIdResponseDataAllOf.end) &&
        Objects.equals(this.endDate, scheduleEventsGetEventByIdResponseDataAllOf.endDate) &&
        Objects.equals(this.endTime, scheduleEventsGetEventByIdResponseDataAllOf.endTime) &&
        Objects.equals(this.color, scheduleEventsGetEventByIdResponseDataAllOf.color) &&
        Objects.equals(this.isMultiDay, scheduleEventsGetEventByIdResponseDataAllOf.isMultiDay) &&
        Objects.equals(this.recurrence, scheduleEventsGetEventByIdResponseDataAllOf.recurrence)&&
        Objects.equals(this.additionalProperties, scheduleEventsGetEventByIdResponseDataAllOf.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ScheduleEventsGetEventByIdResponseDataAllOf {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ScheduleEventsGetEventByIdResponseDataAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ScheduleEventsGetEventByIdResponseDataAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ScheduleEventsGetEventByIdResponseDataAllOf is not found in the empty JSON string", ScheduleEventsGetEventByIdResponseDataAllOf.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ScheduleEventsGetEventByIdResponseDataAllOf.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ScheduleEventsGetEventByIdResponseDataAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ScheduleEventsGetEventByIdResponseDataAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ScheduleEventsGetEventByIdResponseDataAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ScheduleEventsGetEventByIdResponseDataAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<ScheduleEventsGetEventByIdResponseDataAllOf>() {
           @Override
           public void write(JsonWriter out, ScheduleEventsGetEventByIdResponseDataAllOf value) throws IOException {
           ...
           @Override
           public ScheduleEventsGetEventByIdResponseDataAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ScheduleEventsGetEventByIdResponseDataAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ScheduleEventsGetEventByIdResponseDataAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ScheduleEventsGetEventByIdResponseDataAllOf
  * @throws IOException if the JSON string is invalid with respect to ScheduleEventsGetEventByIdResponseDataAllOf
  */
  public static ScheduleEventsGetEventByIdResponseDataAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ScheduleEventsGetEventByIdResponseDataAllOf.class);
  }

 /**
  * Convert an instance of ScheduleEventsGetEventByIdResponseDataAllOf to an JSON string
  *
  * @return JSON string
  */
