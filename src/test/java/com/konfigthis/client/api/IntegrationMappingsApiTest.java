...
public class IntegrationMappingsApiTest {
     ...
     */
    @Test
    public void createSalesCategoryMappingsBulkTest() throws ApiException {
        Long companyId = null;
        Long locationId = null;
        Long departmentId = null;
        String xApiVersion = null;
        UUID xCompanyGuid = null;
        IntegrationMappingsCreateSalesCategoryMappingsBulkResponse response = api.createSalesCategoryMappingsBulk(companyId, locationId, departmentId)
     ...
     */
    @Test
    public void deleteSalesCategoryMappingsTest() throws ApiException {
        Long companyId = null;
        Long locationId = null;
        ...
        String xApiVersion = null;
        UUID xCompanyGuid = null;
        api.deleteSalesCategoryMappings(companyId, locationId, externalId, departmentId)
                .xApiVersion(xApiVersion)
                .xCompanyGuid(xCompanyGuid)
                .execute();
        // TODO: test validations
     ...
     */
    @Test
    public void listSalesCategoryMappingsTest() throws ApiException {
        Long companyId = null;
        Long locationId = null;
        Long departmentId = null;
        String xApiVersion = null;
        ...
        String cursor = null;
        Long limit = null;
        IntegrationMappingsListSalesCategoryMappingsResponse response = api.listSalesCategoryMappings(companyId, locationId, departmentId)
                .xApiVersion(xApiVersion)
                .xCompanyGuid(xCompanyGuid)
                .cursor(cursor)
                .limit(limit)
